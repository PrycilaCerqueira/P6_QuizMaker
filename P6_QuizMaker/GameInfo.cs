namespace P6_QuizMaker
{
    ...
    {
        public static int NUMOFQUESTIONS = 20; //Constant variable
...
Prepare {NUMOFQUESTIONS} quiz cards composed of 1 topic, 1 question and 5 answers. Use your imagination!";
